...
-- Exit insert mode JK
map("i", "jk", "<Esc>", { desc = "Escape insert mode", remap = true })

-- Exit insert mode JK
map("n", "<leader>q", "<cmd>q<cr>", { desc = "Close.", remap = true })

-- better up/down
map({ "n", "x" }, "j", "v:count == 0 ? 'gj' : 'j'", { expr = true, silent = true })
map({ "n", "x" }, "k", "v:count == 0 ? 'gk' : 'k'", { expr = true, silent = true })
map("n", "<C-j>", "<C-d>", { desc = "Go down a lot", remap = true })
map("n", "<C-k>", "<C-u>", { desc = "Go up a lot", remap = true })
